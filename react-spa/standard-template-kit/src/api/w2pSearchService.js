...
export const myDocumentsService = async (size, sortType, sortDirection, offset) => {

  const token = await getApiBearerToken();

  const response = apiServiceHandler(`${BASE_URL}/wp/rest/instances/_search?sort=${sortType}&sort-direction=${sortDirection}&size=${size || 24}&from=${offset}`, {
    method: "POST",
    headers: {
      "Authorization": `Bearer ${token.access_token}`,
      "Content-Type": "application/json"
...
export const inWorkDocumentsService = async (size, sortType, sortDirection, offset) => {
  
  const response = apiServiceHandler(`${BASE_URL}/wp/rest/instances/in-work/my?sort=${sortType}&sort-direction=${sortDirection}&size=${size || 24}&from=${offset}`, {
    method: 'GET',
  })
...
export const finalizedDocumentsService = async (size, sortType, sortDirection, offset) => {
  
  const response = apiServiceHandler(`${BASE_URL}/wp/rest/instances/finalized/my?sort=${sortType}&sort-direction=${sortDirection}&size=${size || 24}&from=${offset}&showArchived=false`, {
    method: 'GET',
  })
...
export const rejectedDocumentsService = async (size, sortType, sortDirection, offset) => {
  
  const response = apiServiceHandler(`${BASE_URL}/wp/rest/instances/rejected/my?sort=${sortType}&sort-direction=${sortDirection}&size=${size || 24}&from=${offset}`, {
    method: 'GET',
  })
...
export const waitingApprovalDocumentsService = async (size, sortType, sortDirection, offset) => {
  
  const response = apiServiceHandler(`${BASE_URL}/wp/rest/instances/waiting-approval/my?sort=${sortType}&sort-direction=${sortDirection}&size=${size || 24}&from=${offset}`, {
    method: 'GET',
  })
...
export const archivedDocumentsService = async (size, sortType, sortDirection, offset) => {
  
  const response = apiServiceHandler(`${BASE_URL}/wp/rest/instances/finalized/my?sort=${sortType}&sort-direction=${sortDirection}&size=${size || 24}&from=${offset}&showArchived=true`, {
    method: 'GET',
  })
